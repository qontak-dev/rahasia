...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'activesupport', ">= 4.0", "< 5.x"
  spec.add_dependency 'lockbox', '~> 0.3.1'
  spec.add_dependency 'vault', '~> 0.13.0'

  spec.add_development_dependency 'rails', '>= 4.2.10', '< 6.1.x'
  spec.add_development_dependency 'bundler', '>= 1.16', '< 2.2.x'
  spec.add_development_dependency 'rake', '>= 10.0', '< 13.2.x'
